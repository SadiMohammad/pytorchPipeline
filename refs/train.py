...
def main():
    ...
    try:
        ...
        for dataset in datasets:
            # directorys = os.path.join(dataset_csv_dir, dataset).replace('\\','/')
            # directorys = directorys + '.csv'

            directorys = dataset_csv_dir + '/' + dataset + '.csv'
            shutil.copy(directorys, output_dir)
